...
console.log("1e temperament van tweede kat", catBreeds[1].temperament[0]);

console.log("laatste temperament van derde kat: ", catBreeds[2].temperament[4]);
